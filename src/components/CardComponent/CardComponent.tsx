...
const buttonTranslate = cn([`${ButtonStyles.buttonTranslate}`, `${ButtonStyles.generalButton}`]);

const Card = forwardRef<HTMLButtonElement, CardProps>(function Card(props, ref) {
